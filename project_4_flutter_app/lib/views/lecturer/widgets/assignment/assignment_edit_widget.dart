...
class _AssignmentEditWidgetState extends State<AssignmentEditWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    _assignmentDueAtController.text = CustomFormatter.formatDateTime(assignment.due_at);
                ...
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Editing assignment...'),
                      ),
                    );
                  }
                  ...
                  _assignmentRepository
                      .updateAssignment(
                        assignment_id: inputAssignment.assignment_id,
