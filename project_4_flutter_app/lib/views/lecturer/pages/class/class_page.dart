    ...
    return Consumer<ClassRepository>(
      builder: (context, classRepository, child) {
        return Scaffold(
          appBar: AppBar(
            title: Text(
              classRepository.classList.firstWhere((a) => a.class_id == widget.classObject.class_id).class_name,
            ),
            actions: [
              MenuAnchor(
                  ...
                  MenuItemButton(
                    onPressed: () => Navigator.push(
                      ...
                      MaterialPageRoute<void>(
                        builder: (context) => ClassEditPage(classObject: classRepository.classList.firstWhere((a) => a.class_id == widget.classObject.class_id)),
                      ),
                    ),
